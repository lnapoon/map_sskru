...
<head>
  ...
  <link rel="stylesheet" href="assets/css/styles.css?v=16.0" />
</head>
<body>
  ...
  <!-- PDPA & Privacy Consent Modal (Friendly & Transparent) -->
  <div class="pdpa-overlay" id="pdpa-modal-overlay">
    <div class="pdpa-card">
      <div class="pdpa-header">
        ...
        <div>
          <h3 class="pdpa-title">ขออนุญาตการเข้าถึงข้อมูลการใช้งาน</h3>
          <p class="pdpa-subtitle">เพื่อความสะดวกในการนำทางและประสบการณ์ใช้งานที่ดีที่สุดของคุณ</p>
        </div>
      </div>
      <div class="pdpa-body">
        <p class="pdpa-intro">ระบบแผนที่ มหาวิทยาลัยราชภัฏศรีสะเกษ ขออนุญาตเข้าถึงข้อมูลที่จำเป็นตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล (PDPA) ดังนี้:</p>
        <div class="pdpa-purpose-list">
          <div class="pdpa-purpose-item">
            <i class="fa-solid fa-location-dot pdpa-item-icon"></i>
            <div>
              <strong>พิกัดตำแหน่ง GPS (ขอสิทธิ์เฉพาะเมื่อกดนำทาง)</strong>
              <p>ใช้คำนวณระยะทางและบอกทิศทางการเดินเท้าไปยัง 40 อาคารในมหาวิทยาลัย</p>
            </div>
          </div>
          <div class="pdpa-purpose-item">
            <i class="fa-solid fa-sliders pdpa-item-icon"></i>
            <div>
              <strong>การตั้งค่าและความจำบนอุปกรณ์ (LocalStorage)</strong>
              <p>บันทึกธีมสีและประวัติการค้นหาไว้เฉพาะในเครื่องของคุณ เพื่อความสะดวกรวดเร็ว</p>
            </div>
          </div>
        </div>
      </div>
      <div class="pdpa-footer">
        <button class="pdpa-btn pdpa-btn-decline" id="btn-pdpa-decline">
          <i class="fa-solid fa-xmark"></i> ใช้งานแบบทั่วไป
        </button>
        <button class="pdpa-btn pdpa-btn-accept" id="btn-pdpa-accept">
          <i class="fa-solid fa-check"></i> ยินยอมและเริ่มใช้งาน
        </button>
      </div>
    </div>
  </div>
